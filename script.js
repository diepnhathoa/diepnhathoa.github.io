document.addEventListener('DOMContentLoaded', () => {
    ...
    tabAdsButton.addEventListener('click', () => switchTab(tabAdsContent, tabAdsButton));
    tabContentButton.addEventListener('click', () => switchTab(tabContentContent, tabContentButton));
    ...
    function appendChatMessage(role, message, animate = true) {
        ...
        if (role === 'ai') {
            ...
            // Lấy chữ cái đầu từ username hoặc sử dụng icon người dùng
    ...
    chatLoginForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                chatInterface.classList.remove('hidden');
                chatHistoryDiv.innerHTML = '';
                appendChatMessage('ai', 'Hey — how can I help you today?');
                loadChatHistory(currentUserId);
            } else {
    ...
    chatForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            appendChatMessage('ai', 'Sorry, I couldn\'t connect to the server. Please check your connection and try again.');
        }
    });
